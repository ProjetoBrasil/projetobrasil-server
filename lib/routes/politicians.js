...
exports.initialPage = function (req, res){
    return ddb.scan('politicians', {attributesToGet:[nome_urna, numero, foto]}, function (err, politicians) {
      if (!err) {
        //console.log(politicians);
        return res.send(politicians.items);
      } else {
...
exports.findProposalsById = function (req, res){
  return ddb.scan('proposals', {filter : { politicians_id : req.params.id}}, function (err, proposals) {
    if (!err) {
...
exports.update = function (req, res){
  ...
  return ddb.updateItem('politicians', req.body.id, null, politician, function (err, politician) {
      if (!err) {
        console.log("updated");
      } else {
        console.log(err);
