...
exports.media = function(req,res){
	/*ddb.scan('ratings', {exclusiveStartKey: {hash: "87c3e6e0-1948-11e4-b2df-1540440903f6", range : null}}, function (err) {
		if (!err) {
	...
	return ddb.getItem('ratings', "87c3e6e0-1948-11e4-b2df-1540440903f6", null, {}, function (err, user) {
		if (!err) {
