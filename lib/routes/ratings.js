...
exports.media = function(req,res){
	var options = {filter:{id:{eq:"87c3e6e0-1948-11e4-b2df-1540440903f6"}},
					exclusiveStartKey: {hash: "87c3e6e0-1948-11e4-b2df-1540440903f6", range : 'luizpcf@gmail.com'}};

	ddb.scan('ratings', options, function (err,ratings) {
		if (!err) {
