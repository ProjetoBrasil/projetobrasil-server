...
multipleFindBlindRatings = function(resolve, reject, options, result){
	if(options == undefined)
		option = {filter : { username: { eq: req._passport.session.user }}};

	ddb.scan('blindRatings', options, function (err, ratings) {
		if (!err){
			if(result == undefined)
...
exports.findCompleteBlindRatingsById = function (req, res){
	var promise = new Promise(multipleFindBlindRatings);
